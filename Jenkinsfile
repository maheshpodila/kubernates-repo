pipeline {
    ...
    environment {
        ...
        GKE_CLUSTER_NAME = 'contosapp-cluster-1' // Update with your GKE cluster name
        GKE_PROJECT_ID = 'cloud-podim-project' // Update with your GCP project ID
        GKE_ZONE = 'us-east1' // Update with your GKE cluster zone
        GIT_REPO_URL = 'https://github.com/maheshpodila/kubernates-repo.git' // Update with your Git repository URL
